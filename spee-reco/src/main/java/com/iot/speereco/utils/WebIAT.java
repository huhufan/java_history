package com.iot.speereco.utils; /**
 * 语音听写 WebAPI 接口调用示例
 * 运行方法：直接运行 main() 即可
 * 结果： 控制台输出语音听写结果信息
 * @author iflytek
...
public class WebIAT {
	...
	private static final String APPID = "5d04bbf2";
	// 接口密钥（webapi类型应用开通听写服务后，控制台--我的应用---语音听写---相应服务的apikey）
	private static final String API_KEY = "8a2ef74d691ca63203ad53d5cbcdc0ce";
	// 音频编码
	...
	private static final String AUDIO_PATH = "C:\\Users\\ASUS-PC\\Desktop\\讯飞语音java\\iat_pcm_16k.pcm";
