...
<div class="container">
    ...
    <div class="row">
        <div class="jumbotron">
            ...
            <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/addUser.jsp" role="button">点击添加用户</a></p>
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${user.userStatus == 0}">
                    <a href="${pageContext.request.contextPath}/delete?id=${user.id}&type=lock">锁定</a>
                    </c:if>
                    <c:if test="${user.userStatus == 1}">
                    <a href="${pageContext.request.contextPath}/delete?id=${user.id}&type=unlock">解锁</a>
                    </c:if>
                    <a href="${pageContext.request.contextPath}/delete?id=${user.id}&type=delete">删除</a>
                </td>
            </tr>
            </c:forEach>
        </table>
